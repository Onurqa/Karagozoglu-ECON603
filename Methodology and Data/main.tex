...
\textbf{AZ Comments:} I only read the data section for now since that was what was due 10/30. This is a good start but needs to be polished. Would you ever see a data section like this in an academic journal? You should write in complete paragraphs and give more information on the sample and time period of the data. The variables you highlight from PSID seem fine, but you provide such minimal information on them as well as how you would use the datasets for the quasi-experimental and comparative analysis. You should write a paragraph for each of these sources and in the first sentence explain why that dataset is well suited for your analysis. For the survey, could you use the GSS? Or would you need to implement your own survey? It is not clear. Please address these concerns for the final version of the project due at the end of the semester.
